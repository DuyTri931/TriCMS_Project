    ...
    <header className="main-header-wrapper bg-white shadow-sm sticky-top">
      <div className="top-bar bg-dark py-2 text-white" style={{ fontSize: "13px" }}>
        <div className="container d-flex justify-content-between align-items-center">
          <div>
            <span className="mr-3"><i className="fas fa-phone-alt mr-1"></i> Hotline: 0909.888.777</span>
            <span><i className="fas fa-envelope mr-1"></i> support@tricmsfootball.vn</span>
          </div>
          <div>
            <Link to="/login" className="text-white mr-3 text-decoration-none">Đăng nhập</Link>
        ...
        <div className="container">
          <nav className="navbar navbar-expand p-0">
            <ul className="navbar-nav w-100">
              <li className="nav-item mr-4"><Link to="/" className={`nav-link p-0 text-decoration-none ${isActive("/")}`}>Trang chủ</Link></li>
              <li className="nav-item mr-4"><Link to="/shop" className={`nav-link p-0 text-decoration-none ${isActive("/shop")}`}>Cửa hàng</Link></li>
              <li className="nav-item mr-4"><Link to="/blog" className={`nav-link p-0 text-decoration-none ${isActive("/blog")}`}>Tin bóng đá</Link></li>
              <li className="nav-item mr-4"><Link to="/cart" className={`nav-link p-0 text-decoration-none ${isActive("/cart")}`}>Giỏ hàng</Link></li>
              <li className="nav-item"><Link to="/checkout" className={`nav-link p-0 text-decoration-none ${isActive("/checkout")}`}>Thanh toán</Link></li>
            </ul>
          </nav>
        </div>
      </div>
